...
service BasilServer {
    ...
    void IdentifyDisplayableObject (
        1: required BasilType.objectIdentifier id,
        2: required BasilType.assetInformation assetInfo,
        3: required BasilType.accessAuthorization accessInfo,
    ...
    BasilType.instanceIdentifier CreateObjectInstance (
        1: required BasilType.objectIdentifier id,
        2: required BasilType.instancePositionInfo pos,
        3: required BasilType.propertyList propertiesToSet
    ) throws (99: BasilType.BasilException e),

    // Update a property of an object. This could effect all instances.
    void UpdateObjectProperty (
        1: required BasilType.objectIdentifier objectId,
        2: required BasilType.propertyList props
    ) throws (99: BasilType.BasilException e),

    // Update a property of an instance
    void UpdateInstanceProperty (
        1: required BasilType.instanceIdentifier instanceId,
        2: required BasilType.propertyList props
    ) throws (99: BasilType.BasilException e),
    ...
    BasilType.propertyList RequestObjectProperties (
        1: required BasilType.messageSequenceNumber sequenceNumber,
        2: required BasilType.objectIdentifier objectId,
        3: string propertyMatch   // wildcard used to match returned properties
    ) throws (99: BasilType.BasilException e),
